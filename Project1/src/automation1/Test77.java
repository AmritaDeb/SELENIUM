/*
	...
	search iphone x and select the 1st auto suggestion
 	...
 	print the min price along with the name and max price along with the name
*/
...
public class Test77 {
	...
	public static void main(String[] args) throws Exception {
		...
		String max_xp = "(//span[@class='lfloat product-price'])[" + count + "]/../../../p";
		String max_name = driver.findElement(By.xpath(max_xp)).getText();
