/*
 	...
 	print the cheapest flight price and then the name of that flight
...
public class Test79 {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("~~~~~~~~~~~~~");		
		String min_name_xp = "(//th[@class='price'])[1]/preceding-sibling::th[5]"; 
		String min_name = driver.findElement(By.xpath(min_name_xp)).getText();
		...
		System.out.println("~~~~~~~~~~~~~");		
		String max_name_xp = "(//th[@class='price'])["+ count + "]/preceding-sibling::th[5]"; 
		String max_name = driver.findElement(By.xpath(max_name_xp)).getText();
